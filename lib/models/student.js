...
StudentSchema.statics.execUpsert = function(externalId, studentData, cb) {
  var self = this;
...
StudentSchema.statics.upsertStudent = function(externalId, data, method, cb) {
  var self = this;
  ...
  self.validateData(data, method, function(err, studentData, result) {
    ...
    if (result.success) {
      ...
      self.execUpsert( externalId, studentData, function(err, loadedStudent) {
